...
export default function TrainerProfile() {
  ...
  const especialidadesQuery = useQuery({
    queryKey: ["entrenador", "especialidades"] as const,
  ...
  const especialidadesValue = especialidadesQuery.isLoading
    ? "Cargando…"
    : (especialidadesQuery.data ?? []).join(", ");
      ...
      >
        <Card>
          ...
          <CardContent className="flex flex-col items-center gap-3 text-center">
            ...
            <p className="text-[11px] text-[rgba(4,14,32,0.55)]">TBD</p>
          </CardContent>
        </Card>
        ...
        <div className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Información de contacto visible para los clientes y el centro.
              </CardDescription>
            </CardHeader>
            <CardContent className="grid gap-4 sm:grid-cols-2">
              ...
              >
                <Input
                  ...
                  placeholder="Aún no tienes actividades asignadas."
                  title="Se actualizan automáticamente según las clases asignadas por administración."
                  className="cursor-not-allowed bg-[#f1f5f9] text-[rgba(4,14,32,0.69)] focus-visible:ring-0"
                />
              </FieldGroup>
            </CardContent>
          </Card>
