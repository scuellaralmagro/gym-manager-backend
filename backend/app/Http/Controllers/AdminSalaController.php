 ...
 *
 * Maneja la creación, actualización y eliminación de salas.
 */
class AdminSalaController extends Controller
{
     ...
     * Eliminar una sala.
     *
     * - clases.id_sala tiene ON DELETE RESTRICT, así que si la sala
     * tiene clases programadas Postgres lanzará una QueryException.
     * Capturamos esa excepción para devolver un 409.
     *
